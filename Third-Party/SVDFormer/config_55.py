...
__C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = './demo/SN55/complete/%s'
__C.DATASETS.SHAPENET55.PARTIAL_POINTS_PATH      = './demo/SN55/partial/%s'
...
__C.CONST.WEIGHTS                                = './pretrained/SVDFormer/ShapeNet55.pth'
