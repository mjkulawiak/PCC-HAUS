...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = './demo/PCN/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = './demo/PCN/%s/complete/%s/%s.pcd'
...
__C.CONST.WEIGHTS                                = './pretrained/SVDFormer/PCN.pth'
