...
def PCNConfig():
    ...
    #__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '../../../PoinTr/PoinTr-master/data/PCNcs/%s/partial/%s/%s/%02d.pcd'
    #__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '../../../PoinTr/PoinTr-master/data/PCNcs/%s/complete/%s/%s.pcd'
    #__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '../../../PoinTr/PoinTr-master/data/Buildings_16384-1638/%s/partial/%s/%s/%02d.pcd'
    #__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '../../../PoinTr/PoinTr-master/data/Buildings_16384-1638/%s/complete/%s/%s.pcd'
    __C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '../data/PCN/data_pcd/%s/partial/%s/%s/%02d.pcd'
    __C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '../data/PCN/data_pcd/%s/complete/%s/%s.pcd'
