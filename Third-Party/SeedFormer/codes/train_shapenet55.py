...
parser.add_argument('--generate_partial', default=False, action="store_true", help='Generate partial data [False, True].')
parser.add_argument('--ignore_truth', default=False, action="store_true", help='Ignore ground-truth point clouds [False, True].')
...
def ShapeNet55Config():
    ...
    __C.DATASETS.SHAPENET55.PARTIAL_POINTS_PATH     = '../data/partial/%s'
    __C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = '../data/complete/%s'
    #__C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = '../../../PoinTr/PoinTr-master/data/ShapeNet55-34/shapenet_pc_c/%s'
    #__C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = '../../../PoinTr/PoinTr-master/data/ShapeNet55-34/Buildings_8192/%s'
    #__C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = '../test/%s'
    ...
    __C.CONST.WEIGHTS                                = '../pretrained/shapenet55/ckpt-best.pth' # specify a path to run test and inference
...
def test_net(cfg):
    ...
    manager.test(cfg, model, val_data_loader, outdir=cfg.DIR.RESULTS if args.output else None, mode=args.mode,
        generate_partial=args.generate_partial, ignore_truth=args.ignore_truth)
